    ...
    >
      ...
      <div
        ...
        className={
          ...
          (narrow ? "w-full max-w-[760px]" : "w-full")
        }
      >
        <div className="shrink-0 border-b border-[var(--color-line)] px-6 py-4 sm:px-10">
          <div className="mx-auto flex w-full max-w-[74ch] items-start gap-4">
        ...
        <div className="flex-1 overflow-y-auto overscroll-contain px-6 py-8 sm:px-10">
          <div className="mx-auto w-full max-w-[74ch] pb-28">{children}</div>
        </div>

        <div className="shrink-0 border-t border-[var(--color-line)] px-6 py-3 sm:px-10">
          <div className="mx-auto flex w-full max-w-[74ch] items-center gap-2">
